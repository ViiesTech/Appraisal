...
const AppHeader = ({
  ...
  const renderContent = () => (
    <View style={[styles.contentContainer, { paddingTop: sizes.screenHeight * 0.03 }]}>
        ...
        {rightActionNode ? (
          ...
          <TouchableOpacity
            ...
            style={[
              ...
              showBackground && styles.rightActionBtnBackground,
            ]}
          >
            {rightActionIcon ? (
              <Icon
      ...
      {showSearch && (
        <View style={styles.searchContainer}>
          <AppInput
            placeholder="Search templates..."
            leftIcon={
              <Icon name="search" size={20} color={colors.textLighter} />
            }
            {...searchProps}
  ...
  if (showBackground) {
    return (
      <ImageBackground
        ...
        style={[styles.container, containerStyle, { paddingTop: 0 }]}
        resizeMode="stretch"
      >
        {renderContent()}
      </ImageBackground>
  ...
  return (
    <View style={[styles.container, containerStyle, { paddingTop: 0 }]}>{renderContent()}</View>
  );
};
