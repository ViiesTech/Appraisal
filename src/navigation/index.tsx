...
import CommentExamples from '../screens/CommentExamples';
...
export type MainStackParamList = {
  ...
  VerifyAccount: { email: string; flow: 'signup' | 'forgotPassword' };
  BottomTab: undefined;
  TemplateLibrary: undefined;
  AssignmentDetails: { orderId: string };
  DocumentViewer: { url: string; title?: string };
  ScheduleInspection: undefined;
  InspectionScheduled: { date: string; time: string };
  InspectionChecklist: { orderId: string; address?: string };
  SubmitFinalReport: undefined;
  EditProfile: undefined;
  Settings: undefined;
  AllCertificates: undefined;
  ChangePassword: undefined;
  CommentExamples: undefined;
  Notes: undefined;
...
const AppStack = () => {
  return (
    ...
    >
      ...
      <Stack.Screen name="CommentExamples" component={CommentExamples} />
