import { Wrapper, HomeHeader, AppScrollView, StatsCards, TemplateLibraryCard, AppTabs, HomeOverview, HomeCertificates } from '../../components';
...
const Home = () => {
    ...
    return (
        <Wrapper style={styles.container} statusBarTranslucent={true}
